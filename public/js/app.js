...
/***/ "./node_modules/js-translate/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function parseArguments(args) {
    ...
    if (typeof args[0] === 'string') {
      ...
      var language = _args[0];
      var data = _args[1];

      defaultLanguage = language;
      dictionary[language] = data;
    } else {
      var list = Array.isArray(args[0]) ? args[0] : args;
  ...
  function i18n(_ref2) {
    var defaultLanguage = _ref2.defaultLanguage;
    var language = _ref2.language;
    var startSeparator = _ref2.startSeparator;
    var endSeparator = _ref2.endSeparator;
    var warning = _ref2.warning;

    var dictionary = {};
    var dictDefaultLanguage = defaultLanguage || '';
    var dictLanguage = '';
    var dictResideLanguage = '';

    var dictStartSeparator = startSeparator || '{';
    var dictEndSeparator = endSeparator || '}';
    var dictWarning = warning;

    var i18n = {
      add: function add() {
        var _parseArguments = parseArguments(Array.prototype.slice.call(arguments));

        var _parseArguments2 = _slicedToArray(_parseArguments, 2);

        var newDictionary = _parseArguments2[0];
        var newDefaultLanguage = _parseArguments2[1];

        if (!defaultLanguage) dictDefaultLanguage = newDefaultLanguage;
        dictionary = Object.assign({}, dictionary, newDictionary);
      },

      useDefaultLanguage: function useDefaultLanguage(lang) {
        if (lang && typeof lang === 'string') dictDefaultLanguage = lang;
      },

      useLanguage: function useLanguage(lang) {
        dictLanguage = lang;
      ...
      getResideLanguage: function getResideLanguage() {
      ...
      _selectPhrase: function _selectPhrase(phrase) {
        function selectPhraseFromDict(lang, phrase) {
          var dictionaryInstance = dictionary[lang];
          return dictionaryInstance ? dictionaryInstance[phrase] : '';
        }

        return selectPhraseFromDict(dictLanguage, phrase) || selectPhraseFromDict(dictResideLanguage, phrase) || selectPhraseFromDict(dictDefaultLanguage, phrase);
      },
      ...
      translate: function translate() {
        ...
        var result = i18n._selectPhrase(phrase);
        var args = Array.prototype.slice.call(arguments, 1);

        var wildCardRegex = new RegExp(dictStartSeparator + '.+?' + dictEndSeparator, 'g');

        var wildcards = phrase.match(wildCardRegex);
        var replaceHash = {};

        if (wildcards) {
          wildcards.forEach(function (wildcard, i) {
            replaceHash[wildcard] = args[i];
          });
        }

        if (!result) {
          var errorMessage = 'error during translation with following parameters:\n          phrase – ' + phrase + ', dictLanguage – ' + dictLanguage;
          if (dictWarning === 'warn') console.warn(errorMessage);
          if (dictWarning === 'error') throw new Error(errorMessage);
          result = phrase;
        }

        result = result.replace(wildCardRegex, function (replacer) {
          var value = replaceHash[replacer];
          return value || '';
        });
 ...
 * @type {Object}
 */
window.JSTranslate = __webpack_require__("./node_modules/js-translate/lib/index.js");
window.Swiper = __webpack_require__("./node_modules/swiper/dist/js/swiper.js");
...
=======
throw new Error("Module build failed: ModuleBuildError: Module build failed: \n@import \"components/animation\";\n^\n      File to import not found or unreadable: /Applications/MAMP/htdocs/the-giversnetwork/resources/assets/sass/components/_animation.scss.\n      in /Applications/MAMP/htdocs/the-giversnetwork/resources/assets/sass/app.scss (line 22, column 1)\n    at runLoaders (/Applications/MAMP/htdocs/the-giversnetwork/node_modules/webpack/lib/NormalModule.js:195:19)\n    at /Applications/MAMP/htdocs/the-giversnetwork/node_modules/loader-runner/lib/LoaderRunner.js:364:11\n    at /Applications/MAMP/htdocs/the-giversnetwork/node_modules/loader-runner/lib/LoaderRunner.js:230:18\n    at context.callback (/Applications/MAMP/htdocs/the-giversnetwork/node_modules/loader-runner/lib/LoaderRunner.js:111:13)\n    at Object.asyncSassJobQueue.push [as callback] (/Applications/MAMP/htdocs/the-giversnetwork/node_modules/sass-loader/lib/loader.js:55:13)\n    at Object.done [as callback] (/Applications/MAMP/htdocs/the-giversnetwork/node_modules/neo-async/async.js:8077:18)\n    at options.error (/Applications/MAMP/htdocs/the-giversnetwork/node_modules/node-sass/lib/index.js:294:32)");
>>>>>>> 01ce47681b9f80006e7d5aa09705348677f898ab
