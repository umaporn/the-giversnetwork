...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Give Page Language Lines
    |--------------------------------------------------------------------------
    */

    'page_link' => [
        'index'  => 'Give',
        'detail' => 'Give: :give_title',
    ],
    ...
    'give_type_selection'     => 'Please select give or ask item',
    'receive'                 => 'Ask',
    'give_item'               => 'Give/Ask Item',
    'tell_giver'              => 'Give/Ask Item',
    'contact_giver'           => 'Contact giver',
    'do_you_need'             => 'Log in for more information',
    'i_need_contact'          => 'Click to view contact information',
    'other_user_item'         => 'Other user\'s items',
    'other_item'              => 'Other Items',
    'give_or_receive'         => 'Give Items or Ask Items',

    'create_item_form' => [
        'choose'              => 'Choose',
        'give_item'           => 'I have an item, service, or a volunteer to offer',
        'receive'             => 'I need an item, service, or volunteer',
        'category'            => 'Category',
        'name'                => 'Title',
        'amount'              => 'Amount',
        'address'             => 'Address',
