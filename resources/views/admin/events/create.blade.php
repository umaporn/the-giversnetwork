                                ...
                                <div class="cell small-12">
                                    ...
                                    >
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            ...
                                            <div class="cell small-12 large-9">
                                                <div class="form-date">
                                                    ...
                                                    <p id="event_date-help-text" class="alert help-text help-text hide"></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid-x grid-padding-x user-form-space">
                                            ...
                                            <div class="cell small-12 large-9">
                                                <div class="form-date">
                                                    <input type="date" id="start_date" name="start_date" class="form-fill">
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            ...
                                            <div class="cell small-12 large-9">
                                                <div class="form-date">
                                                    <input type="date" id="end_date" name="end_date" class="form-fill">
