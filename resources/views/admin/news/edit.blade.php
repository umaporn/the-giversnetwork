...
@section('page-title', __('news_admin.page_title.edit'))
@section('page-description', __('news_admin.page_description.edit'))
                            ...
                            <div class="grid-x">
                                <div class="cell small-12">
                                    <div class="grid-x user-form-space">
                                        <h2 class="cell shrink user-head">@lang('news_admin.edit_news')</h2>
                                    ...
                                    >
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            <div class="cell small-12 large-2">
                                                <label for="news_id" class="form-label">@lang('news_admin.news_id')</label>
                                            </div>
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            ...
                                            <div class="cell small-12 large-9">
                                                <textarea id="description_english" class="form-fill" name="description_english" rows="3">{{ $news->description_english }}</textarea>
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            <div class="cell small-12 large-offset-2 large-9">
                                                <button class="btn-green btn-long">@lang('news_admin.edit_news')</button>
                                            </div>
                                        </div>
                                    </form>
