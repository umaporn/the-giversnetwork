...
@section('page-title', __('banner_admin.page_title.index'))
@section('page-description', __('banner_admin.page_description.index'))
                            ...
                            <div class="grid-x">
                                <div class="cell small-12">
                                    <div class="grid-x admin-form-space admin-search">
                                        <h2 class="cell shrink admin-head">@lang('banner_admin.page_title.all')</h2>
                                        <div class="cell auto grid-x align-middle">
                                            ...
                                            <div class="margin-left-1">
                                                <div class="input-group input-search">
                                                    <form id="search-form-detail" class="cell search" method="GET" action="{{ route('admin.banner.index') }}">
                                ...
                                <div class="cell small-12">
                                    <section class="table-scroll table-admin">
                                        <table>
                                            <thead>
                                            <tr>
                                                <th>@lang('banner_admin.no')</th>
                                                <th>@lang('banner_admin.title')</th>
                                                <th>@lang('banner_admin.image')</th>
                                                <th>@lang('banner_admin.publish')</th>
                                                <th>@lang('banner_admin.edit')</th>
                                                <th>@lang('banner_admin.delete')</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <nav aria-label="Pagination">
                                        {{ $banners->links('admin.pagination.normal') }}
                                    </nav>
                                </div>
                            </div>
                        </article>
