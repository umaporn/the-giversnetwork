...
@section('page-title', __('challenge_admin.page_title.challenge_add'))
@section('page-description', __('challenge_admin.page_description.challenge_add'))
                            ...
                            <div class="grid-x">
                                <div class="cell small-12">
                                    <div class="grid-x user-form-space">
                                        <h2 class="cell shrink user-head">@lang('challenge_admin.add_new_thread')</h2>
                                ...
                                <div class="cell small-12">
                                    <form action="{{ route('admin.challenge.store') }}"
                                          method="POST"
                                    ...
                                    >
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            ...
                                            <div class="cell small-12 large-9">
                                                <textarea id="content-tinymce-thai" name="content_thai" class="form-fill" rows="3"></textarea>
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            ...
                                            <div class="cell small-12 large-9">
                                                <textarea id="content-tinymce-english" name="content_english" class="form-fill" rows="3"></textarea>
                                        ...
                                        <div class="grid-x grid-padding-x user-form-space">
                                            <div class="cell small-12 large-offset-2 large-9">
                                                <button class="btn-green btn-long">@lang('challenge_admin.create_thread')</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
