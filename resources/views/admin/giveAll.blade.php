                            ...
                            <div class="grid-x">
                                <div class="cell small-12">
                                    <div class="grid-x user-form-space admin-search">
                                        <h2 class="cell shrink user-head">All Give</h2>
                                ...
                                <div class="cell small-12">
                                    <section class="table-scroll table-admin">
                                        <table>
                                            ...
                                            <tr>
                                                <td>00019</td>
                                                <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                                                    tempor erat nec augue sollicitudin, eu vulputate enim vestibulum. In
                                                    hac habitasse platea dictumst. Mauris tincidunt metus turpis, eget
                                                    interdum metus
                                                </td>
                                                <td>2.1k</td>
                                                <td>100</td>
