    ...
    <section class="news padding-content">
        ...
        <div class="grid-x grid-margin-x ">
            <article class="cell small-12 medium-4">
                <figure>
                    <img src="{{ asset(config('images.home.news.home_news_01' )) }}" alt="">
                </figure>
                        ...
                        <div class="grid-x grid-margin-x recent-share">
                            <article class="cell grid-x medium-12 large-6">
                                <div class="cell small-12 medium-5">
                                    <figure>
                                        <img src="{{ asset(config('images.home.share.home_share_01' )) }}" alt="">
                                    </figure>
                                </div>
                                <div class="cell grid-x small-12 medium-7">
                                    <a href="#"><h4 class="cell">Title - Lorem ipsum dolor sit amet, consectetur
                                                                 adipiscing elit. Suspendisse eget nibh arcu.</h4></a>
                                    <div class="cell grid-x align-self-bottom">
                                        ...
                                        <div class="cell shrink like">
                                            <i class="far fa-thumbs-up"></i><span>415 likes</span></div>
                                        <div class="cell shrink comment"><i class="far fa-comments"></i><span>500 comments</span>
                                        </div>
                                    </div>
                                </div>
                            </article>
