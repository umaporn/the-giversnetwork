                    ...
                    <section class="user-profile-after float-left" data-toggle="user-menu">
                        ...
                        <div class="dropdown-pane user-menu" id="user-menu" data-dropdown data-hover="true" data-hover-pane="true" data-v-offset=15>
                            <ul class="user-menu-show">
                                <li><a href="{{ route('user.updateProfile') }}"><i class="fas fa-user-edit"></i> @lang('user.edit_profile')</a></li>
                                <li><a href="{{ route('user.getProfile') }}"><i class="fas fa-user-circle"></i> @lang('user.view_profile')</a></li>
                                <li>
                                    <form action="{{ route('logout') }}" method="POST" name="logout">
                                        {{ csrf_field() }}
                                        <a onclick="document.logout.submit();"><i class="fas fa-sign-out-alt"></i> @lang('login.logout_button')</a>
                                    </form>
                                </li>
                            </ul>
                        </div>
